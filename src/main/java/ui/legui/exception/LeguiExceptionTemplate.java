...
public enum LeguiExceptionTemplate {
    ...
    /**
     * Marshal exception. Used by {@link ui.legui.marshal.json.JsonMarshaller}.
     */
    MARSHAL_EXCEPTION("Can't marshal your component"),
    /**
     * Unmarshal exception. Used by {@link ui.legui.marshal.json.JsonMarshaller}.
     */
    UNMARSHAL_EXCEPTION("Can't unmarshal your component"),
    /**
     * Used by {@link ui.legui.style.font.Font}.
     */
    FAILED_TO_LOAD_FONT("Failed to initialize font. (%s)"),
    /**
     * Used by {@link ui.legui.image.BufferedImage}.
     */
