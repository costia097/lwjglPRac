...
import ui.legui.component.RadioButtonGroup;
...
import ui.legui.component.event.selectbox.SelectBoxChangeSelectionEventListener;
import ui.legui.component.event.slider.SliderChangeValueEvent;
import ui.legui.component.event.slider.SliderChangeValueEventListener;
...
import ui.legui.listener.KeyEventListener;
...
import ui.legui.util.TextUtil;
import org.lwjgl.glfw.GLFW;

import static ui.legui.component.optional.align.HorizontalAlign.CENTER;
import static ui.legui.component.optional.align.HorizontalAlign.LEFT;
import static ui.legui.component.optional.align.HorizontalAlign.RIGHT;
import static ui.legui.component.optional.align.VerticalAlign.BASELINE;
import static ui.legui.component.optional.align.VerticalAlign.BOTTOM;
import static ui.legui.component.optional.align.VerticalAlign.MIDDLE;
import static ui.legui.component.optional.align.VerticalAlign.TOP;
import static ui.legui.event.MouseClickEvent.MouseClickAction.CLICK;
import static ui.legui.event.MouseClickEvent.MouseClickAction.PRESS;
import static ui.legui.event.MouseClickEvent.MouseClickAction.RELEASE;
...
public class ExampleGui extends Panel {
    ...
    public ExampleGui(int width, int height) {
        ...
        Icon bgIm = new ImageIcon(new BufferedImage("ui/legui/demo/1.png"));
        bgIm.setSize(new Vector2f(20, 20));
        turnWidVisible.getStyle().getBackground().setIcon(bgIm);
        Icon hbgIm = new ImageIcon(new BufferedImage("ui/legui/demo/2.png"));
        hbgIm.setSize(new Vector2f(20, 20));
//        turnWidVisible.setHoveredBackgroundIcon(hbgIm);
        Icon pbIm = new ImageIcon(new BufferedImage("ui/legui/demo/3.png"));
...
//                widget3.setResizable(!widget3.isResizable());
    ...
    private Widget createImageWrapperWidgetWithImage() {
        ...
        imageView = new ImageView(new BufferedImage("ui/legui/demo/1.jpg"));
    ...
    private ToggleButton createToggleButtonWithLongTooltip() {
        ...
        Icon bgImageNormal = new ImageIcon(new BufferedImage("ui/legui/demo/toggle.png"));
