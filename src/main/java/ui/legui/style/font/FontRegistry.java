...
public class FontRegistry {
    ...
    static {
        registerFont(ENTYPO, "ui/legui/style/font/entypo.ttf");
        registerFont(ROBOTO_BOLD, "ui/legui/style/font/Roboto-Bold.ttf");
        registerFont(ROBOTO_LIGHT, "ui/legui/style/font/Roboto-Light.ttf");
        registerFont(ROBOTO_REGULAR, "ui/legui/style/font/Roboto-Regular.ttf");
        registerFont(MATERIAL_ICONS_REGULAR, "ui/legui/style/font/MaterialIcons-Regular.ttf");
        registerFont(FONT_AWESOME_ICONS, "ui/legui/style/font/FontAwesome.otf");
        registerFont(MATERIAL_DESIGN_ICONS, "ui/legui/style/font/materialdesignicons.ttf");
    }
